...
def process_pdf():
    ...
    return len(chunks), len(figure_mapping), images_by_page, text_by_page, figure_mapping


# ✅ initialize empty (instead of blocking)
images_by_page = {}
text_by_page = {}
figure_mapping = {}

# =====================================================
# 4️⃣ Background processing (NEW)
# =====================================================
def init_background():
    global images_by_page, text_by_page, figure_mapping
    try:
        print("🚀 Starting PDF processing in background...")
        _, _, images_by_page, text_by_page, figure_mapping = process_pdf()
...
# =====================================================
# 8️⃣ MAIN (UPDATED for Render)
# =====================================================
if __name__ == "__main__":
    port = int(os.environ.get("PORT", 7860))

    # ✅ start background processing
    threading.Thread(target=init_background).start()
